...
public class LocationBuilder : MonoBehaviour
{
    ...
    void AssignLocationVariables(LocationImportsData locdata, Location loc)
    {
        ...
        loc.offloadOne = locdata.Offload1;
        loc.offloadTwo = locdata.Offload2;
        loc.offloadThree = locdata.Offload3;
        loc.offloadResource = locdata.Resourceoffload;
        loc.offloadDifficultyOne = locdata.Difficulty1;
        loc.offloadDifficultyTwo = locdata.Difficulty2;
        loc.offloadDifficultyThree = locdata.Difficulty3;
